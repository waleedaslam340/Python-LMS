...
import styles from '@/app/dashboard/kid/KidDashboard.module.css';
import { htmlCurriculum as curriculum } from '@/lib/curriculum/html-data';
import ProgressBar from '@/components/ProgressBar';
import { Rocket, Trophy, Star, ChevronRight, CheckCircle, Layout, Terminal } from 'lucide-react';
import { getLocalCompletedLessons } from '@/lib/progress';

export default function HTMLKidDashboard() {
      ...
      <div className={styles.grid}>
        <div className={styles.mainCol}>
          <section className={styles.card}>
            ...
            <div className={styles.missionItem} onClick={() => router.push(`/html-lessons/${nextLesson.week}`)}>
              ...
              {curriculum.slice(0, 5).map(lesson => {
                ...
                return (
                  <div 
                    ...
                    onClick={() => router.push(`/html-lessons/${lesson.week}`)}
                  >
        ...
        <aside className={styles.sidebar}>
          ...
          <section className={styles.card} style={{ marginTop: '2rem' }}>
            ...
            <p style={{ color: '#636E72', lineHeight: 1.6 }}>
              HTML is the skeleton of the web! Try to close your tags properly.
            </p>
          </section>
        </aside>
      </div>
